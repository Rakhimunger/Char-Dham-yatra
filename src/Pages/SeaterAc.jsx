...
const SeaterAc = () => {
  return (
    <div className="px-4 py-6 sm:px-6 md:px-10 max-w-screen-lg mx-auto text-gray-800 text-sm sm:text-base space-y-5 leading-relaxed">
      <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-blue-800 mb-2">
